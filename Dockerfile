...
RUN apk add --no-cache --virtual .runtime-deps libgfortran libffi freetype libpng netcat-openbsd jpeg-dev zlib-dev cython
...
RUN conda install matplotlib pandas jupyter seaborn xlrd openpyxl pytables
EXPOSE 8888
